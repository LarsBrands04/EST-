const int pressurePin = A1;  // Define the analog input pin connected to the sensor
...
void loop() {
float airflowValue = analogRead(airflowPin);  // Read the analog value from the sensor (0-1023)
float pressureValue = analogRead(pressurePin);  // Read the analog value from the sensor (0-1023)
